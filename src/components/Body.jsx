...
const Body = () => {
  return (
    <div className="space-y-4 lg:flex">
      <div className="flex items-centre justify-center lg:flex-1 lg:order-2 lg:justify-end">
        <img
      ...
      <div className="lg:flex-1 lg:order-1">
        ...
        <p className="font-lato text-gray-400">
          We provide reliable and efficient web hosting solutions tailored to
          your needs. Whether you are launching a personal blog, a business
          website, or an e-commerce store, our robust infrastructure ensures top
